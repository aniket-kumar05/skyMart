...
const Register = () => {
  ...
  const formSubmit = (data) => {
    ...
    toast.success("Account created! Welcome to SkyMart", { position: "bottom-right" });
    navigate("/home");
    reset();
  };
  ...
  const handleFocus = (e) => e.target.closest("div").style.borderColor = "#C8FF00";
  const handleBlur  = (e) => e.target.closest("div").style.borderColor = "#2a2a2a";
    ...
    <div style={{ minHeight: "100vh", display: "flex", background: "#0d0d0d", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", position: "relative", zIndex: 1 }}>
          <div style={{
            width: 44, height: 44, background: "#C8FF00", borderRadius: 12,
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(34px, 3.5vw, 48px)", fontWeight: 800, color: "#fff", lineHeight: 1.1, margin: "0 0 12px" }}>
            Your next great
          </h1>
          <h2 style={{ fontSize: "clamp(34px, 3.5vw, 48px)", fontWeight: 800, color: "#C8FF00", lineHeight: 1.1, margin: "0 0 24px" }}>
            purchase awaits.
          </h2>
          <p style={{ color: "#6b6b6b", fontSize: 15, lineHeight: 1.7, maxWidth: 320, margin: "0 0 48px" }}>
            Create your free account and explore thousands of products with lightning-fast delivery.
          </p>
        ...
        <div style={{ width: "100%", maxWidth: 420 }}>
          ...
          {emailExists && (
            <div style={{
              ...
              color: "#FF4D4D", fontSize: 13, borderRadius: 10, padding: "10px 14px", marginBottom: 14,
            }}>
              ⚠ Email already registered!
            </div>
          )}

          <form onSubmit={handleSubmit(formSubmit, onInvalid)} style={{ display: "flex", flexDirection: "column", gap: 12 }}>

            {/* Full Name */}
            <div style={wrapStyle}>
              <User size={16} color="#555" style={{ flexShrink: 0, marginRight: 12 }} />
              <input
